...
def create_pipeline(
    ...
    trainer_args = {
        ...
        "custom_executor_spec": executor_spec.ExecutorClassSpec(
            trainer_executor.GenericExecutor # 기본 training executor는 tf.Estimator를 지원하기 때문에, GenericExecutor로 덮어씌움(기본 executor는 entry point가 run_fn()이 아니라 trainer_fn()이라함.)
        ),
    }
